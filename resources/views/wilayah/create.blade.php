                ...
                <form method="POST" action="{{ route('jalan.store') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select name="id_kecamatan" class="form-control @error('id_kecamatan') is-invalid @enderror mb-2">
                            @foreach ($wilayahs['kecamatan'] as $wilayah)
                            <option value="{{ $wilayah['id_kecamatan'] }}">{{ $wilayah['nama_kecamatan'] }}</option>
                                @endforeach
                            </select>
                            @error('id_kecamatan')
